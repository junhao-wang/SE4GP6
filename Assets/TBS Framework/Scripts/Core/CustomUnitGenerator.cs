...
public class CustomUnitGenerator : MonoBehaviour, IUnitGenerator
{
	...
	public virtual void Awake()
    {
        ...
        unitAudio = new Dictionary<string, Dictionary<string, AudioClip>>() {
            ...
            {"Genomorphe", (new Dictionary<string, AudioClip>(){ { "atkHp", sfx.Crossbow }, { "atkArmor", sfx.Crossbow2 }, { "gun", sfx.LeesGun }, { "aoe", sfx.Grenade },{ "move", sfx.Walk1 },{ "death", sfx.Grenade } }) },
            ...
            {"Trooper1", (new Dictionary<string, AudioClip>(){ { "atkHp", sfx.Crossbow }, { "atkArmor", sfx.Crossbow2 }, { "gun", sfx.LeesGun }, { "aoe", sfx.Grenade },{ "move", sfx.Walk1 },{ "death", sfx.Grenade } }) },
            {"Trooper2", (new Dictionary<string, AudioClip>(){ { "atkHp", sfx.Crossbow }, { "atkArmor", sfx.Crossbow2 }, { "gun", sfx.LeesGun }, { "aoe", sfx.Grenade },{ "move", sfx.Walk1 },{ "death", sfx.Grenade } }) },
